...
const NEWRADIO_ATTACK_SPEED: float = 3.0
const NEWRADIO_RANGE: float = 250.0
const NEWRADIO_COST: int = 300

# OldDrone
const OLDDRONE_DAMAGE: float = 8.0
const OLDDRONE_ATTACK_SPEED: float = 5.0
const OLDDRONE_RANGE: float = 300.0
const OLDDRONE_COST: int = 120

# FightingDrone
const FIGHTINGDRONE_DAMAGE: float = 20.0
const FIGHTINGDRONE_ATTACK_SPEED: float = 3.0
const FIGHTINGDRONE_RANGE: float = 400.0
const FIGHTINGDRONE_COST: int = 350

# Blaster
const BLASTER_DAMAGE: float = 18.0
